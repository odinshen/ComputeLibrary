...
/*****************************************************************************/
#define IntBase         0x2C000000 /* Interrupt Controller Base             */
#define FIQBase         0x14000020  /* FIQ Controller Base                   */
#define TimerBase       0x1C110000  /* Counter/Timer Base                    */
#define CoreBase        0x10000000  /* Core Module Registers                 */

#define UART0Base       0x13001000  /* UART0 Registers                       */
#define UART1Base       0x1C0A0000  /* UART1 Registers                       */
...
#define UART0_LCRM *((volatile unsigned *)(UART0Base + 0x28))
#define UART0_LCRL *((volatile unsigned *)(UART0Base + 0x24))
...
#define UART1_DR   *((volatile unsigned *)UART1Base)
#define UART1_RSR  *((volatile unsigned *)(UART1Base + 0x04))
#define UART1_ECR  *((volatile unsigned *)(UART1Base + 0x04))
#define UART1_LCRH *((volatile unsigned *)(UART1Base + 0x2C))
#define UART1_LCRM *((volatile unsigned *)(UART1Base + 0x28))
#define UART1_LCRL *((volatile unsigned *)(UART1Base + 0x24))
#define UART1_CR   *((volatile unsigned *)(UART1Base + 0x30))
#define UART1_FR   *((volatile unsigned *)(UART1Base + 0x18))
#define UART1_IIR  *((volatile unsigned *)(UART1Base + 0x1C))
#define UART1_ICR  *((volatile unsigned *)(UART1Base + 0x44))
