...
C:\ARM\aarch64-elf\gcc-linaro-7.2.1-2017.11-i686-mingw32_aarch64-elf\bin\aarch64-elf-g++ baremetal/aemv8a/vectors.o baremetal/aemv8a/stackheap.o baremetal/aemv8a/retarget-gcc.o baremetal/aemv8a/pagetables.o baremetal/aemv8a/output_trickbox.o baremetal/aemv8a/neon_cnn_baremetal.o baremetal/aemv8a/bootcode.o -o baremetal/aemv8a/neon_cnn_bm_example_v8a.elf -I. -Lbuild-arm64-v8a -larm_compute-static -larm_compute_core-static -T baremetal/aemv8a/link_csrc_aarch64.ld -march=armv8-a -specs=nosys.specs -fstack-protector -g
